...
#check if confg file already exists
pFile="${the_client}-wgo.conf"
if [[ -f "{pFile}" ]]
then
	echo "Config file exists, do you want to overide (y/n)"
	read response	
else
	echo "config file does not exist, making file"
fi
